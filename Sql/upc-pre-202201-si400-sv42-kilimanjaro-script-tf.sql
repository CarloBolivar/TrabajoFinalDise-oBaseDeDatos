...
CREATE TABLE Contrato (
    ...
    CEmpleadosupervisor char(4)  NOT NULL,
    MPagoHoraExtra money  NOT NULL,
    CONSTRAINT Contrato_pk PRIMARY KEY  (CContrato)
);

insert into Contrato
values ('CT01','2022-01-01','2022-12-31','1.200,00','CH01','CU01','NULL'), 
('CT02','2022-01-01','2022-12-31','1.000,00','CH02','CU02','CU04'), 
('CT03','2022-01-01','2022-12-31','2.500,00','CH01','CU03','NULL'), 
('CT04','2022-01-01','2022-12-31','1.500,00','CH01','CU04','NULL'), 
('CT05','2022-01-01','2022-12-31','1.000,00','CH02','CU05','CU01'), 
('CT06','2022-01-01','2022-12-31','1.000,00','CH01','CU06','CU04'), 
('CT07','2022-01-01','2022-12-31','1.000,00','CH02','CU07','CU01'), 
('CT08','2022-01-01','2022-12-31','1.000,00','CH01','CU08','CU04'), 
('CT09','2022-01-01','2022-12-31','1.000,00','CH02','CU09','CU04'), 
('CT10','2022-01-01','2022-12-31','1.000,00','CH02','CU10','CU01'), 
('CT11','2020-01-01','2020-12-31','1.200,00','CH01','CU01','NULL'), 
('CT12','2020-01-01','2020-12-31','1.000,00','CH02','CU02','CU04'), 
('CT13','2020-01-01','2020-12-31','2.500,00','CH01','CU03','NULL'), 
('CT14','2020-01-01','2020-12-31','1.500,00','CH01','CU04','NULL'), 
('CT15','2020-01-01','2020-12-31','1.000,00','CH02','CU05','CU01'), 
('CT16','2020-01-01','2020-12-31','1.000,00','CH01','CU06','CU04'), 
('CT17','2020-01-01','2020-12-31','1.000,00','CH02','CU07','CU01'), 
('CT18','2020-01-01','2020-12-31','1.000,00','CH01','CU08','CU04'), 
('CT19','2020-01-01','2020-12-31','1.000,00','CH02','CU09','CU04'), 
('CT20','2020-01-01','2020-12-31','1.000,00','CH02','CU10','CU01'), 
('CT21','2021-01-01','2021-12-31','1.200,00','CH01','CU01','NULL'), 
('CT22','2021-01-01','2021-12-31','1.000,00','CH02','CU02','CU04'), 
('CT23','2021-01-01','2021-12-31','2.500,00','CH01','CU03','NULL'), 
('CT24','2021-01-01','2021-12-31','1.500,00','CH01','CU04','NULL'), 
('CT25','2021-01-01','2021-12-31','1.000,00','CH02','CU05','CU01'), 
('CT26','2021-01-01','2021-12-31','1.000,00','CH01','CU06','CU04'), 
('CT27','2021-01-01','2021-12-31','1.000,00','CH02','CU07','CU01'), 
('CT28','2021-01-01','2021-12-31','1.000,00','CH01','CU08','CU04'), 
('CT29','2021-01-01','2021-12-31','1.000,00','CH02','CU09','CU04'), 
('CT30','2021-01-01','2021-12-31','1.000,00','CH02','CU10','CU01')
...
CREATE TABLE Ruta (
    CRuta char(5)  NOT NULL,
    NumLongitudinicio decimal(70,40)  NOT NULL,
    NumLatitudinicio decimal(70,40)  NOT NULL,
    NumLongitudfin decimal(70,40)  NOT NULL,
    NumLatitudfin decimal(70,40)  NOT NULL,
    CONSTRAINT Ruta_pk PRIMARY KEY  (CRuta)
);

insert into Ruta
values ('CR1','-12,111139','-76,988898','-12,112737','-77,013711'),
('CR2','-12,111139','-76,988898','-12,104645','-76,964613'),
('CR3','-12,111139','-76,988898','-12,114434','-76,987496'),
('CR4','-12,111139','-76,988898','-12,109394','-76,993244'),
('CR5','-12,111139','-76,988898','-12,114439','-76,991807'),
('CR6','-12,111139','-76,988898','-12,107044','-76,98969'),
('CR7','-12,111139','-76,988898','-12,112952','-76,990651'),
('CR8','-12,111139','-76,988898','-12,109606','-76,984493'),
('CR9','-12,111139','-76,988898','-12,111716','-76,981602'),
('CR10','-12,111139','-76,988898','-12,122885','-76,985677')
